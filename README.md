...
**Tools:** SQLite / PostgreSQL · SQL · Python (database setup script)  
**Approach:** Business questions inspired by common analytical patterns discussed in the data community
---
